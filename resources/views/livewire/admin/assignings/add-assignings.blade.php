        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control" wire:model="owner_name" readonly>
                </div>
            </div>
            <div class="row">
                <div class="mb-3 col-md-6">
                ...
                <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputZip">{{$lang->data['contact_person'] ?? 'Site Branch'}}</label>
                    <input type="text" class="form-control" wire:model="contact_person" readonly>
